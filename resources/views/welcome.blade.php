        ...
        <div class="services-columns" id="price">
          ...
          <div class="services-details" id="service-details">
            ...
            <div class="service-accordion">
              @php
                $serviceDescriptions = [
                    'Загальний масаж тіла' => 'Ідеальний варіант, коли тіло втомлене, а голова перевантажена — масаж допомагає повністю перезавантажитись і відчути легкість у всьому тілі. Після сеансу зникає напруга, покращується сон і повертається відчуття внутрішнього балансу.',
                    'Класичний масаж (будь-яка зона)' => 'Якщо турбує спина, шия чи інша зона — цей масаж швидко допоможе зняти дискомфорт і м’язові затиски. Вже після першого сеансу тіло стає більш розслабленим, а рухи — легшими.',
                    'Лімфодренаж' => 'Чудовий вибір, коли є набряки, важкість у тілі або хочеться “прибрати зайве”. Масаж запускає природне очищення організму, дарує легкість та допомагає тілу виглядати більш підтягнутим.',
                    'Медовий масаж' => 'Процедура для тих, хто хоче не лише розслабитись, а й отримати гладеньку, пружну шкіру. Мед активно прогріває тіло, покращує кровообіг і залишає приємне відчуття оновлення після сеансу.',
                    'Масаж обличчя + декольте' => 'Допомагає швидко освіжити обличчя, зняти сліди втоми та повернути шкірі здоровий тонус. Після процедури обличчя виглядає більш доглянутим, свіжим і відпочилим.',
                    'Міостимуляція' => 'Ідеально для тих, хто хоче підтягнути тіло та привести м’язи в тонус без виснажливих тренувань. Процедура допомагає зробити контури тіла більш вираженими та підтягнутими.',
                    ...
                    'Кавітація' => 'Процедура для тих, хто хоче позбутися локальних жирових відкладень без болю та операцій. Допомагає коригувати фігуру та зробити проблемні зони менш помітними.',
                    'RF-ліфтинг' => 'Ідеальний варіант для підтяжки шкіри та боротьби з втратою пружності. Процедура стимулює вироблення колагену, завдяки чому шкіра виглядає молодшою та більш підтягнутою.',
                    'Вакуумний масаж' => 'Сильний ефект для тих, хто хоче покращити стан шкіри та позбутися застійних явищ у тілі. Масаж активно стимулює кровообіг, допомагає зменшити целюліт і відчути легкість після процедури.',
                    'Пресотерапія' => 'Ідеально після важкого дня або при сидячій роботі, коли ноги “гудуть” і є набряки. Процедура дарує неймовірне відчуття легкості та допомагає тілу швидше відновитись.',
                    'Міопресура ШКЗ (шийно-комірцева зона)' => 'Ідеальний масаж для людей із сидячою роботою, постійною напругою в шиї та головними болями. Допомагає прибрати затиски, полегшити стан і повернути комфорт у рухах.',
                    'Масаж ШКЗ (шийно-комірцева зона)' => 'Швидке розслаблення для шиї та плечей після стресу, роботи чи фізичного навантаження. Після процедури зникає відчуття скутості та напруження у верхній частині тіла.',
                    'Спина + руки + шия' => 'Комплексний масаж для тих, хто відчуває втому у спині, плечах та руках. Допомагає швидко відновити тіло та відчути легкість уже після першого сеансу.',
                    'Міопресура ніг' => 'Глибока робота з м’язами ніг для усунення болю, затисків та перенавантаження. Ідеально підходить після активного дня, спорту або при постійній втомі в ногах.',
                    'Масаж ніг' => 'Розслабляючий масаж, який повертає ногам легкість і комфорт. Допомагає зняти втому, набряки та приємно розвантажити ноги після навантажень.',
                    'Міопресура рук' => 'Ефективний масаж для тих, хто багато працює руками або відчуває напругу в кистях і передпліччях. Допомагає зняти втому, покращити рухливість і прибрати дискомфорт.',
                    'Масаж рук' => 'Приємний розслабляючий масаж для відновлення рук після навантаження чи тривалої роботи. Дарує легкість, покращує кровообіг і допомагає зняти напругу.',
                    'Вогняний масаж з пропрацюванням м’язів' => 'Незвичайна процедура з потужним прогріваючим ефектом для глибокого розслаблення м’язів. Допомагає швидко відновити тіло, зняти втому та отримати новий заряд енергії.',
                    'Масаж блейдами' => 'Сучасна техніка масажу для глибокого опрацювання м’язів і фасцій. Ідеально підходить для зняття затисків, покращення рухливості та відновлення після навантажень.',
                ];

                $serviceDetails = collect($serviceDescriptions)
                    ->map(fn (string $description, string $title): array => [
                        'label' => $title,
                        'display_label' => $title,
