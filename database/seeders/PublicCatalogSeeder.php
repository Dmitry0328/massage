    ...
    public function catalog(): array
    {
        ...
        return [
            'olesia' => [
                ...
                $this->fixed('olesia-klasicnii-masaz-bud-iaka-zona-45', 'Класичний масаж (будь яка зона)', 45, 500, 'Покращує кровообіг, знімає мʼязову напругу, розслабляє та допомагає відновитися після навантажень.'),
    ...
    private function apparatus(string $prefix, array $items): array
    {
        return array_map(fn (array $item): array => [
            ...
            'description' => match ($item[1]) {
                ...
                'ЕНДОСФЕРА' => 'Ендосфера-терапія — це апаратний масаж, який покращує кровообіг і лімфодренаж. Допомагає зменшити набряки, целюліт та зробити шкіру більш підтягнутою і гладкою.',
